...
<body>
    ...
    <form action="{{route('rutaActualizar',$p->id)}}" method="post">
        ...
        <input type="number" name="id" disabled="disabled" value="{{$p->id}}"><br>
        ...
        @error('libro')
        <div>Rellena el Libro</div>
        @enderror

        <label for="cliente">Cliente</label><br>
        <input type="text" name="cliente" value="{{$p->cliente}}"><br>
        @error('cliente')
